...
const sha = await git.commit({ fs, dir, message: 'Persist Pomodoro timer across navigation + mini timer in sidebar', author: { name: 'Salman Zulfiqar', email: 'ss3000569@gmail.com' } });
