...
const sha = await git.commit({ fs, dir, message: 'Fix Express 5 wildcard route for production static serving', author: { name: 'Salman Zulfiqar', email: 'ss3000569@gmail.com' } });
