...
const sha = await git.commit({ fs, dir, message: 'Seed Salman user on server startup — fix FK errors on Supabase', author: { name: 'Salman Zulfiqar', email: 'ss3000569@gmail.com' } });
